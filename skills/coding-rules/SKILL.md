---
name: coding-rules
description: Opinionated mandatory coding rules for TypeScript/React development. Contains non-negotiable standards covering code structure, code co-location, React patterns, TypeScript safety, testing, and tooling. Consult this skill whenever writing or modifying any TypeScript or React code — components, hooks, tests — even if the user hasn't explicitly asked about coding standards. Also use when reviewing code, refactoring, or when something "looks off." These rules override default coding instincts.
---
